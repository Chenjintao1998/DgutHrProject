	...
	<div data-options="region:'west',split:true,title:'公司人事信息管理'  " style="width: 200px;">
		...
		<div id="aa" class="easyui-accordion" style="width: 100%; height: 70%;text-align: center;">
			...
			<div title="部门管理" data-options="iconCls:'icon-edit',selected:true"
				style="padding: 10px;">
				<a href="#" class="easyui-linkbutton" data-options="iconCls:'icon-search'" style="width:100px;margin-bottom: 20px;" onclick="add('部门查询','user_search.jsp')">部门查询</a>
				 <a href="#"  class="easyui-linkbutton" data-options="iconCls:'icon-user_add'" style="width:100px" onclick="add('添加部门','user_add.jsp')">添加部门</a>
				
				</div>

			<div title="职位管理" data-options="iconCls:'icon-remove',selected:true"
				style="padding: 10px;">
				<a href="#" class="easyui-linkbutton" data-options="iconCls:'icon-search'" style="width:100px;margin-bottom: 20px;" onclick="add('职位查询','user_search.jsp')">职位查询</a>
				 <a href="#"  class="easyui-linkbutton" data-options="iconCls:'icon-user_add'" style="width:100px" onclick="add('添加职位','user_add.jsp')">添加职位</a>
