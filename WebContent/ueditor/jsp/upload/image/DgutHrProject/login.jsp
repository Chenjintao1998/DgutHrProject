...
<body>
	<form action="${pageContext.request.contextPath}/login" method="post" onsubmit="return check(this)">
		...
		<div style="width: 400px; padding: 50px 60px; background-image: url('logincss/img/bg1.png'); margin: 0 auto; margin-top: 100px">
			<div style="margin-bottom: 20px">
				<input class="easyui-textbox"  name="username" prompt="賬號" iconWidth="28" style="width: 100%; height: 34px; padding: 10px;">
			</div>
			<div style="margin-bottom: 20px">
				<input class="easyui-passwordbox" name="password" prompt="密碼" iconWidth="28" style="width: 100%; height: 34px; padding: 10px">
			</div>
			
			
			<div style="margin-bottom: 20px">
				<input class="easyui-textbox" id="checkcode" name="checkcode" prompt="驗證碼" iconWidth="28" style="width: 100%; height: 34px; padding: 10px">
			</div>
			
			<div style="margin-bottom: 20px">
				<img alt="图片飞了" src="kaptcha" title="看不清,换一张" onclick="changeCode()" id="codeimg">
			</div>
			<button type="submit" class="easyui-linkbutton c1" style="width: 120px" >登錄</button>
		</div>
	</form>
</body>
