...
<!--表单查询  -->
     ...
     <form id="ff" method="post" action="">
           <label for="number">部门号</label><input class="easyui-numberbox" style="width:200px" 
           name="id" id="id" value=""/>
           
             <label for="name">部门名</label><input class="easyui-textbox" style="width:200px" 
           name="name" id="name"/>
...
var role = ${param.role};
$(function(){
	   getData("${pageContext.request.contextPath}/getdept");   
 ...
 function submitForm(){
    	   ...
    	   getData("${pageContext.request.contextPath}/findDeptLike",id,name); 
	   ...
	   var pager = $('#dg').datagrid().datagrid('getPager');	// get the pager of datagrid
		pager.pagination({
			buttons:[
			{
				...
				handler:function(){
					if(role == 1){
						$.messager.alert('错误提示', '你无权限修改部门', 'error');
						return;
					}
